...
const Location: Template<TemplateRenderProps> = ({
  ...
  React.useEffect(() => {
    fetch(
      "https://liveapi-sandbox.yext.com/v2/accounts/me/entities?api_key=3a4e2ab6997c4fbdb1fe76431fb3b4b1&v=20230117&entityTypes=location")
      .then((res) => res.json())
      .then((json) => {
  ...
  //   photoGallery.map((keyindex:any)=>{
  //          return <h2>helo here</h2>
  //   })
